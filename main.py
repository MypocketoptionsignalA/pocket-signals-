...
async def delayed_first_signal(context: ContextTypes.DEFAULT_TYPE, cid: int, user_id: int):
    """Send first signal after 2 seconds delay"""
    import asyncio
